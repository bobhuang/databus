...
for h in ${remote_hosts} ; do
  ssh -tt $h "nohup tools/remote/run_n_consumers.sh g3000c5p10 eat1-app170.corp.linkedin.com:11183 com.linkedin.events.member2.profile.MemberProfile 2000 50000000 10 300s $ts 1"
done
