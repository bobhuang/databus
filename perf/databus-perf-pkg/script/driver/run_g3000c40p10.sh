...
for h in ${remote_hosts} ; do
  ssh -tt $h "nohup tools/remote/run_n_consumers.sh g3000c40p10 eat1-app170.corp.linkedin.com:11183 com.linkedin.events.member2.profile.MemberProfile 2000 50000000 10 1200s $ts 4"
done

${genscript} -s 40 -b 3000 -e 3000 -t 1800000 --server_host=eat1-app170.corp.linkedin.com --server_port=11183
