...
def conf_and_deploy_GLU(target, action):
  ...
  glu_cmd_template = "/usr/local/linkedin/bin/glu --debug -f my-dev -c http://localhost:8080 -U admin -x admin %s --system_filter=\"mountPoint='/%s'\""
  if action == "undeploy":
      stop_cmd = glu_cmd_template % ("stop", target)
      print stop_cmd
      sys_call(stop_cmd)
  glu_cmd = glu_cmd_template%(action, target)
  print glu_cmd
  sys_call(glu_cmd)
...
cmd_dict_mp_beta={
    ...
    ,"profile_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run","stop": kill_cmd_template % "Member2RelayServer","stats":[get_stats,"Member2RelayServer"]}
    ,"bizfollow_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run-bizfollow","stop": kill_cmd_template % "BizFollowRelayServer","stats":[get_stats,"BizFollowRelayServer"],"shutdown":[shutdown]}
    ,"conn_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run-conn","stop": kill_cmd_template % "ConnectionsRelayServer","stats":[get_stats,"ConnectionsRelayServer"],"shutdown":[shutdown]}
    ,"liar_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run-liar","stop": kill_cmd_template % "LiarRelayServer","stats":[get_stats,"LiarRelayServer"],"maxscn":[get_inbound_total_maxStreamWinScn],"minscn":[get_inbound_total_minStreamWinScn]}
    ,"fault_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run-fault-relay","stop": kill_cmd_template % "FaultInjectionHttpRelay","stats":[get_stats,"FaultInjectionHttpRelay"],"maxscn":[get_inbound_total_maxStreamWinScn],"minscn":[get_inbound_total_minStreamWinScn], "fake":[send_fake_relay_cmd], "unfake":[send_unfake_relay_cmd], "shutdown":[shutdown]}
    ...
    ,"db_relay":{"start":"databus-profile-relay/databus-profile-relay-run/run.py --Dtest=run-db-relay","stop":kill_cmd_template % "DBTestRelayServer","stats":[get_stats,"DatabusRelayMain"]}
    ,"relay_container":{"start":[conf_and_deploy_GLU, "databus2-relay", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay", "undeploy"]}
    ,"relay_deploy":{"start":[conf_and_deploy_GLU, "******NO-IMPL*******", "deploy"],"stop":[conf_and_deploy_GLU, "*******NO-IMPL*******", "undeploy"]}
    ,"anet_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-anet-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-anet","undeploy"]}
    ,"bizfollow_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-bizfollow-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-bizfollow","undeploy"]}
    ,"cappr_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-cappr-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-cappr","undeploy"]}
    ,"conn_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-conn-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-conn","undeploy"]}
    ,"dev_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-dev-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay","undeploy"]}
    ,"following_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-following-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-following","undeploy"]}
    ,"forum_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-forum-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-forum","undeploy"]}
    ,"liar_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-liar-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-liar", "undeploy"]}
    ,"mbrrec_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-mbrrec-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-mbrrec","undeploy"]}
    ,"member2_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-member2-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-member2","undeploy"]}
    ,"news_relay_deploy":{"start":[conf_and_deploy_GLU, "databus2-relay-news-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-relay-news","undeploy"]}
    ,"bootstrap_producer_container":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer", "undeploy"]}
    ,"anet_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-anet-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-anet", "undeploy"]}
    ,"bizfollow_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-bizfollow-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-bizfollow", "undeploy"]}
    ,"cappr_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-cappr-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-cappr", "undeploy"]}
    ,"conn_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-conn-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-conn", "undeploy"]}
    ,"following_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-following-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-following", "undeploy"]}
    ,"forum_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-forum-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-forum", "undeploy"]}
    ,"liar_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-liar-war","deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-liar", "undeploy"]}
    ,"mbrrec_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-mbrrec-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-mbrrec", "undeploy"]}
    ,"member2_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-member2-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-member2", "undeploy"]}
    ,"news_bst_producer_deploy":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-producer-news-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-producer-news", "undeploy"]}
    ,"bootstrap_producer_deploy":{"start":[conf_and_deploy_GLU, "*******NO-IMPL********", "deploy"],"stop":[conf_and_deploy_GLU, "*****NO-IMPL*****", "undeploy"]}
    ,"bootstrap_server_container":{"start":[conf_and_deploy_GLU, "databus2-bootstrap-server", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-server", "undeploy"]}
    ,"bootstrap_server_deploy":{"start":[conf_and_deploy_GLU,"databus2-bootstrap-server-war", "deploy" ],"stop":[conf_and_deploy_GLU, "databus2-bootstrap-server", "undeploy"]}
    ,"client_container":{"start":[conf_and_deploy_GLU, "*****NO-IMPL*****", "deploy"],"stop":[conf_and_deploy_GLU, "****NO-IMPL****", "undeploy"]}
    ,"test_consumer_deploy":{"start":[conf_and_deploy_GLU,"databus2-client-test-consumer-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-test-client", "undeploy"]} 
    ,"test_multiclient_consumer_deploy":{"start":[conf_and_deploy_GLU,"databus2-multi-client-test-consumer-war", "deploy"],"stop":[conf_and_deploy_GLU, "databus2-multi-test-client", "undeploy"]} 
