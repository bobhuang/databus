...
public class TestRelayIntegrationOne extends DatabusBaseIntegTest
{
  ...
  @Test
  public void testRelayTxnChunkingInsert()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
  ...
  @Test
  public void testRelayTxnChunkingUpdate()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
    runCommandLineTest("relay_liar_txn_chunking_update.test");
  }

  @Test
  public void testRelayTxnChunkingSlowSourcesInsert()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
    runCommandLineTest("relay_liar_txn_chunking_slow_sources_insert.test");
  }

  @Test
  public void testRelayTxnChunkingMixedSourcesInsert()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
    runCommandLineTest("relay_liar_txn_chunking_mixed_sources_insert.test");
  }

  @Test
  public void testRelayTxnChunkingSlowSourcesUpdate()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
    runCommandLineTest("relay_liar_txn_chunking_slow_sources_update.test");
  }

  @Test
  public void testRelayTxnChunkingMixedSourcesUpdate()
    throws SecurityException, NoSuchMethodException, IOException, InterruptedException, TimeoutException
  {
    runCommandLineTest("relay_liar_txn_chunking_mixed_sources_update.test");
  }
}
