...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="zk-log-analyzer" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.linkedin.helix.tools.ZkLogAnalyzer %CMD_LINE_ARGS%
