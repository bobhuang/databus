...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="zk-log-parser" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.linkedin.helix.tools.ZKLogFormatter %CMD_LINE_ARGS%
