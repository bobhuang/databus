...
log4j_file_option="-l ${conf_dir}/relay_perf_log4j.properties"
config_file_option="-p ${conf_dir}/relay_perf_${source_name}.properties"
...
case "${source_name}" in 
  "bizfollow" ) main_class=com.linkedin.databus.relay.bizfollow.BizFollowRelayServer ;;
  "liar" ) main_class=com.linkedin.databus.relay.liar.LiarRelayServer ;;
  "member2*" ) main_class=com.linkedin.databus.relay.member2.Member2RelayServer ;;
  "member2_mmap" ) main_class=com.linkedin.databus.relay.member2.Member2RelayServer ;;
  * ) cp conf/sources-${source_name}.json conf/sources-TEST.json ;
