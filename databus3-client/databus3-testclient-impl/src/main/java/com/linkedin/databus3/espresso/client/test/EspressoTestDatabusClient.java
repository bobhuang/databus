  ...
  throws IOException, DatabusException, DatabusClientException
  {
	  ...
	  for(String dbNameString : allSubscriptions) {
		  ...
		  try
		  {
	        ...
	        String dbName = "";
		    if (!dbNameString.startsWith(EspressoSubscriptionUriCodec.SCHEME))
		    {
		    ...
		    else
		    {
		      ...
		      LOG.info("found consumer subscription: " + ds);
		    }
		  ...
		  {
		    throw new DatabusClientException("invalid subscription URI:" + e.getMessage(), e);
		  }
		  ...
		  {
			  consumerConfBuilder.setValueDumpFile(valueDumpFile + "." +
			                                       ds.getPhysicalPartition().getName() + "_" +
			                                       ds.getPhysicalPartition().getId());
		  	  LOG.info("dump_file: " + consumerConfBuilder.getValueDumpFile());
		  }

		  LOG.info("subscribing for pid=" + ds.getPhysicalPartition().getId() +
		           ";db=" + ds.getPhysicalPartition().getName() + ";ds="+ds);
