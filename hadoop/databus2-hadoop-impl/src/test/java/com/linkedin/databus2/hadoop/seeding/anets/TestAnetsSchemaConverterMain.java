...
public class TestAnetsSchemaConverterMain
{
		...
		throws Exception
	{
		...
		inputRecord.put("name", new Utf8("bob"));
		inputRecord.put("locale", new Utf8("en-us"));
		inputRecord.put("createdAt", 5L);
		inputRecord.put("updatedAt", 6L);
		inputRecord.put("urlKey", new Utf8("D"));
		inputRecord.put("privateKey", new Utf8("E"));
		inputRecord.put("ownerId", 7L);
		inputRecord.put("shortDescription", new Utf8("F"));
		inputRecord.put("description", new Utf8("G"));
		inputRecord.put("largeLogoId", new Utf8("H"));
		inputRecord.put("smallLogoId", new Utf8("X"));
		inputRecord.put("vanityUrl", new Utf8("I"));
		inputRecord.put("category", new Utf8("J"));
		inputRecord.put("otherCategory", new Utf8("K"));
		inputRecord.put("contactEmail", new Utf8("b@b"));
		inputRecord.put("homeSite", new Utf8("L"));
		inputRecord.put("country", new Utf8("US"));
		inputRecord.put("postalCode", new Utf8("94089"));
		inputRecord.put("geoPostalCode", new Utf8("94043"));
		inputRecord.put("regionCode", 8);
		inputRecord.put("geoPlaceCode", new Utf8("M"));
		inputRecord.put("geoPlaceMaskCode", new Utf8("N"));
